...
for jahr= start_jahr:end_jahr
    for monat= start_month:end_month
        ...
        ['finish loading mapping and wind files:' jahrstr monatstr]
    end;
end;
['finish loading mapping and wind files']
...
for k=1:size(time_list,1)
    ...
    if not(strcmp(fname,'Z:\DATASETS\www.temis.nl\airpollution\no2col\data\omi\data_v2\2010\01\19\OMI-Aura_L2-OMDOMINO_2010m0119t0629-o29329_v003-2011m0814t222704.he5'))
